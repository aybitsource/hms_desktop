...
public class BookingContainer extends JPanel implements ChangeListener{
	...
	public BookingContainer(MainPage mpg) {
		...
		tabbedPane.addTab("Room Booking", new BookingSingleContainer());
		tabbedPane.addTab("Multiple Booking", null);
		tabbedPane.addTab("Hall Booking", null);		
	...
	public void stateChanged(ChangeEvent arg0) {
		...
		{
			tabbedPane.setComponentAt(0, new BookingSingleContainer());
		}
