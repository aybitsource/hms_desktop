...
public class Constants {
	...
	//Class CheckInEntry
	public final static String checkInEntryNames[]={"BOOKING ID", "ROOM NUMBER", "CHECKIN DATE", "ADULTS", "CHILDREN", "ADVANCE AMOUNT"};
	public final static String[] checkInEntryTipStr = {"Booking ID", "Room Number", "CheckIn date", "Total Adults", "Total Children", "Advance Amount"};
	...
	//Class CheckOut
	public final static String checkOutEntryNames[]={"BOOKING ID", "CHECKOUT DATE"};
	public final static String[] checkOutEntryTipStr = {"Booking ID", "CheckOut date"};
