...
public class DatabaseConstants {
	...
	public static String TABLE_ROOM_FACILITES_NAME = "select roomFacilitiesName, roomFacilitiesDesc, roomFacilitiesPrice from roomFacilities where roomFacilitiesName = ?";
	public static String ROOM_FACILITIES_NAME = "select roomFacilitiesName from roomfacilities";
	public static String UPDATE_FACILITIES = "update roomfacilities  set roomFacilitiesName = ?, roomFacilitiesDesc = ?, roomFacilitiesPrice = ? where roomFacilitiesName = ?";
	...
	public static String TABLE_COUPON_NAME = "select couponName, couponDiscount, couponType from coupons where couponName = ?";
	public static String UPDATE_COUPONS = "update coupons set couponName = ?, couponDiscount = ?, couponType = ? where couponName = ?";
	...
	public static String TABLE_SEASON_NAME = "select seasonName, dateStart, dateEnd, couponName from seasons where seasonName = ?";
	public static String UPDATE_SEASON = "update seasons set seasonName = ?, dateStart = ?, dateEnd = ?, couponName = ? where seasonName = ?";
...
//	public static String TABLE_EMPLOYEES = "select firstName, lastName, username, password, email, mobile, birthDate, gender from employees where role = '"+Constants.USER+"'";
	...
	public static String TABLE_ROOM_COLS_DNO = "select roomDoorNumber, roomCategoryID, roomStatus from rooms  where roomDoorNumber = ?";
	public static String UPDATE_ROOM = "update rooms set roomDoorNumber = ?, roomCategoryID = ?, roomStatus = ? where roomDoorNumber = ?";
	...
	public static String UPDATE_BOOKING_STATUS = "update booking set status = ? where bookingID = ?";
	...
	public static String CANCEL_BOOKING = "select bookingID, firstName, lastName, b1.mobile, bookingDate, bookedDate, checkoutDate, roomCategoryID, roomDoorNumber, bookingTotalNights, bookingRoomCost, facilitiesCost from booking b1 inner join customers c1 on b1.mobile = c1.mobile where bookingID = ?";
	...
	//Checkin Table
	public static String ALL_CHECKIN_ID = "select bookingID, roomDoorNumber, checkInDate, totalAdults, totalChilds, advanceAmt from checkin where bookingID = ?";
	...
	public static String TABLE_CHECK_IN_COLS = "select b1.bookingID, b1.roomDoorNumber, checkInDate, totalAdults, totalChilds, advanceAmt from booking b1 inner join checkin c1 on b1.bookingID = c1.bookingID where status = '"+Constants.CHECKIN+"'";
	public static String CHECKIN_ADULTS_CHILDS = "select totalAdults, totalChilds from checkin where bookingID = ?";
	
	//Checkout Table
	public static String ALL_CHECKOUT_ID = "select bookingID, checkOutDate from checkout where bookingID = ?";
	...
	public static String TABLE_CHECKOUT_COLS = "select  bookingID, checkOutDate from checkout";
	public static String TABLE_CHECKOUT_COLS_USER = "select c1.bookingID, c1.checkOutDate from checkout c1 inner join booking b1 on c1.bookingID = b1.bookingID where b1.invoiceID not like '"+Constants.PREFIX_TAX_LESS+"%'";
