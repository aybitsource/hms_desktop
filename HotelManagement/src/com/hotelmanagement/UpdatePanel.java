...
//		}
		...
		else if(jtupl.getSelectedIndex()==2)
		{
			...
			jtupl.setComponentAt(2, new RoomEntry());
		}	

		else if(jtupl.getSelectedIndex()==3)
		{

			jtupl.setComponentAt(3, new RoomFacilitiesEntry());
		}	
		else if(jtupl.getSelectedIndex()==4)
		{

			jtupl.setComponentAt(4, new HotelEntry());
		}
		else if(jtupl.getSelectedIndex()==5)
		{

			jtupl.setComponentAt(5, new CouponEntry());
		}
		else if(jtupl.getSelectedIndex()==6)
		{

			jtupl.setComponentAt(6, new SeasonEntry());
		}
