...
public class Login extends JDialog implements ActionListener,FocusListener,MouseListener {
	...
	public Login(MainPage mpg) {		
		...
		}
		{
			...
			gbc_txtAdmin.gridx = 2;
			gbc_txtAdmin.gridy = 2;
			contentPanel.add(txtAdmin, gbc_txtAdmin);
		...
		txtAdmin.addFocusListener(this);
	...
	public int retrivePass()
	{
		...
		psmt.setString(1,txtAdmin.getText().trim());
...
//			}
						...
						{
							userName = txtAdmin.getText().toUpperCase()+" ";
